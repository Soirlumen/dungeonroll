...
void inventory::add_item( int _newitemid)
{
...
itemtype inventory::use_item( int _itemid)
{
    remove_item(_itemid);
    return get_itemtype(_itemid);
}

void inventory::remove_item( int _removingitemid)
{
